...
const Hero = () => {
  return (
    <div className="relative bg-[#04142B] mt-[-90px] pt-[138px] pb-[128px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="absolute w-[600px] h-[600px] sm:w-[750px] sm:h-[750px] md:w-[963px] md:h-[963px] bg-[#0037FF] blur-[280px] sm:blur-[400px] md:blur-[585.2px] rounded-full top-[60%] translate-y-[-50%]"></div>
    </div>
  );
};
